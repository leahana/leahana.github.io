# optimize-doc 配套：Markdown 起稿模板

本文档是 `optimize-doc` 拆分出的模板资产文档，用来提供起稿时
可直接复制和裁剪的 Markdown 骨架。

## 文档定位

- 角色：模板集合与起稿入口
- 适用阶段：开始写新文章、需要先选结构时
- 对应 skill 环节：选模板、生成初稿骨架

## 与 skill 的关系

本文档是 `optimize-doc` 的公开配套文档之一。

- 面向对象：仓库协作者、博客维护者、需要快速起稿的人
- 文档职责：提供可复制模板和选型建议
- skill 职责：在具体任务中选用合适模板并继续补全内容

## 适用时机

当你要写一篇新文章、但还不想先进入“深度优化”流程时，
从本文档开始。
