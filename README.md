...
|:-----|:-----|
| **设计模式** | Java 设计模式深入解析 |
| **后端技术** | Spring · MySQL · Redis 等解决方案 |
| **AI & Agent** | Agent 架构 · Prompt 工程 · API 管理 |
| **工具指南** | Obsidian · MCP · CLI 等效率工具 |
| **游戏 & 动漫** | 游戏、动漫相关思考 |
| **随想杂记** | 个人成长、思维方式 |
...
```bash
git clone --recurse-submodules https://github.com/leahana/leahana.github.io.git
cd leahana.github.io && git checkout hexo
